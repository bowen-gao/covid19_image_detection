...
def main():
    ...
    train_covid_index = np.random.choice(covid_index, len(covid_index), replace=False)
    train_normal_index = np.random.choice(normal_index, len(normal_index), replace=False)
    train_pneumonia_index = np.random.choice(pneumonia_index, len(pneumonia_index), replace=False)
    train_index = []
